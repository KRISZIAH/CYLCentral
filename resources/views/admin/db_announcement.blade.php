        ...
        <div class="col-lg-11">
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="ms-auto d-flex">
                    ...
                    <a href="{{ route('programs.create') }}" class="px-4 py-2" style="background: var(--gradient-brown); color: white; border-radius: 8px; font-size: 16px; font-weight: 500; border: none; text-decoration: none; display: inline-block;">Add New</a>
                </div>
            </div>
