...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/main-css/eventregispage.css') }}">
@endpush

@push('scripts')
    <script src="{{ asset('js/main-js/eventregispage.js') }}"></script>
@endpush
                        ...
                        <div class="radio-options-wrapper">
                            ...
                            <div class="radio-option" onclick="selectPayment('paymongo')" id="opt-paymongo">
                                <div class="radio-header">
                                    ...
                                    <img src="{{ asset('img/event_pages/paymongo.png') }}" alt="PayMongo" class="paymongo-logo">
                                </div>
                                <p class="small">
