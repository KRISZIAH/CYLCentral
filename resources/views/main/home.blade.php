    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6 mb-4 mb-md-0">
                <img src="{{ asset('img/home/welcome.png') }}" alt="CYLC Event" class="img-fluid rounded">
            </div>
            <div class="col-md-6">
                <div class="welcome-content">
                    <h6>Welcome to</h6>
                    <img src="{{ asset('img/home/cylcentral-logo3.png') }}" alt="CYLC logo" class="img">
                    <p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="feature-image">
                    <img src="{{ asset('img/home/get-involve.png') }}" alt="Leadership Event" class="img-fluid rounded">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="services-images">
                    <div class="row">
                        <div class="col-12 mb-4">
                            <img src="{{ asset('img/home/service-1.png') }}" alt="Service" class="img-fluid rounded">
                        </div>
                        <div class="col-6 pr-2">
                            <img src="{{ asset('img/home/service-2.png') }}" alt="Service" class="img-fluid rounded">
                        </div>
                        <div class="col-6 pl-2">
                            <img src="{{ asset('img/home/service-3.png') }}" alt="Service" class="img-fluid rounded">
                        </div>
                    </div>
                </div>
            </div>
