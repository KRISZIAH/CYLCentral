...
@section('content')
    ...
    <!-- Hero Section -->
    <section id="hero" class="hero section" style="background-image: url('{{ asset('/img/membership.png') }}');">
              ...
              <div class="col-md-12">
                  <div class="card service-card">
                      <div class="row g-0">
                          <div class="stat-item">
                              <div class="logo">
                                  <img src="{{ asset('img/CYLC logo.png') }}" alt="CYLC Logo">
                                  <div>
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                <img src="{{ asset('img/image 60.png') }}" alt="Business Meeting" class="img-fluid main-image rounded-4">
                <img src="{{ asset('img/image 60.png') }}" alt="Team Discussion" class="img-fluid small-image rounded-4">
              </div>
